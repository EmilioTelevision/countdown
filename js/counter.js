...
DaysHMSCounter.prototype.update=function(){ 
    ...
    this.container.innerHTML =
        "<div class='data'>" + this.days + " " + "<p class='counter_slots'>" + (this.days == 1? "day" : " days")  + "</p>" + "</div>" +
        "<div class='data'>" + this.hours + " " + "<p class='counter_slots'>" + (this.hours == 1? "hour" : " hours")  + "</p>" + "</div>" +
        "<div class='data'>" + this.mins + " " + "<p class='counter_slots'>" + (this.mins == 1? "min" : " mins")  + "</p>" + "</div>" +
        "<div class='data'>" + this.secs + " " + "<p class='counter_slots'>" + (this.secs == 1? "sec" : " secs")  + "</p>" + "</div>" 
    var self = this;
    setTimeout(function(){self.update();}, (1000));
}
 
window.onload=function(){ new DaysHMSCounter('December 17, 2013 15:00:00', 'counter'); }
